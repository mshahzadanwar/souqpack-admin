...
<div class="wrap" style="width: 793px;">
	<div class="header">
		<img src="<?php echo base_url().'resources/emails/header_received_en.jpg';?>">
	</div>
	<div class="inner_content" style="float: left;width: 100%;padding: 23px 66px;box-sizing: border-box;">
		...
		<div style="float: left; width: 100%; margin-bottom: 20px;">
			Awesome Items, Thank you for shopping from Souqpack
		</div>
		<div style="width: 100%;float: left;">
			...
			<div style="float: left;width: 34%; background: #f8f8ef; padding: 5px;margin-right: 10px;"></div>
		...
		<div style="float: left;width: 100%; margin-top: 15px; margin-bottom: 20px;">
				<span style="color: #7ecc20; font-weight: bold; float: left;">Order Received</span>
...
on your order may not include vat amounts, how ever Total amount shall include all added Vat amounts
		...
		<div style="float: left;width: 100%; border-top: 1px solid #efefef;border-bottom: 1px solid #efefef; margin-top:10px">
			<p style="margin-bottom: 8px; margin-top: 0; font-size: 13px; float: left;width: 100%; padding-top: 10px;">We will let you know when your order on its way , Stay Exited !</p>
			<p style="margin-bottom: 8px; margin-top: 0; font-size: 13px; float: left;width: 100%; ">For your safety and for a better Delivery , Kindly Follow healthy and safety procedures</p>
			...
			<p style="margin-bottom: 8px; font-size: 13px;margin-top: 0; float: left;width: 100%;">Till your order arrives, Stay safe , Stay Home</p>
