...
<div class="wrap" style="width: 793px;">
	<div class="header">
		<img src="<?php echo base_url().'resources/emails/corde_final_en.jpg';?>">
	</div>
	<div class="inner_content" style="float: left;width: 100%;padding: 23px 66px;box-sizing: border-box;">
		...
		<div style="float: left; width: 100%; margin-bottom: 20px;">
			Congratulations on the fulfillment of your order [ORDER_NUMBER], as you expected the highest level of service. Please make a final payment to ensure that your
order is processed by the logistics team at the specified time<br>
<br>
We are delighted to give you the finest service.
		</div>
