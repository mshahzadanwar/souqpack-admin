...
<div class="wrap" style="width: 793px;">
	<div class="header">
		<img src="<?php echo base_url().'resources/emails/header_completed_ar.jpg';?>" alt="order received">
	</div>
	<div class="inner_content" style="float: left;width: 100%;padding: 23px 66px;box-sizing: border-box;">
		...
		<div style="float: left; width: 100%; margin-bottom: 20px;text-align: right;">
			[ORDER_NUMBER] تم تسليم منتج من طلبيتك
		</div>
		<div style="width: 100%;float: left;">
			...
			<div style="float: right;width: 20%; background: #7ecc20; padding: 5px;"></div>
		</div>
		<div style="float: right;width: 100%; margin-top: 10px; margin-bottom: 30px; text-align: right;">
				<span style="color: #7ecc20; font-weight: bold; float: right;">تم التسليم</span>
		...
		<div style="float: left;width: 100%;">
			<div style="float: right;width: 42%; margin-left: 1%; background: #f6f6f6; padding: 15px 20px;height: 100px; text-align: right;" >
				...
				<div style="float: left;width: 100%; margin-bottom: 3px;">
					<span style="float: right; margin-right: 20px; font-size: 12px;width: 40%;">:رقم الطلبية </span>
					<span style="float: right;font-size: 11px;">[ORDER_NUMBER]</span>
				</div>
				<div style="float: left;width: 100%;margin-bottom: 3px;">
					<span style="float: right; margin-right: 20px; font-size: 12px;width: 40%;">:جمالي الطلبية </span>
					<span style="float: right;font-size: 11px; direction: rtl;">[TOTAL_AMOUNT]</span>
				</div>
				<div style="float: left;width: 100%;">
					<span style="float: right; margin-right: 20px; font-size: 12px;width: 40%;">:وسيلة الدفع</span>
			...
			<div style="float: right;width: 42%; margin-left: 1%; background: #f6f6f6; padding: 15px 20px;height: 100px;">
				...
				<div style="float: left;width: 100%; margin-bottom: 10px;">
					<span style="float: right;    text-align: right; margin-right: 20px; font-size: 12px; font-weight:bold;width: 100%;">[SHIPPING_CUSTOMER_NAME]</span>
				</div>
				<div style="float: left;width: 100%;margin-bottom: 15px;">
					<span style="float: right;    text-align: right; margin-right: 20px; font-size: 12px;width: 100%;">[SHIP_ADDR]</span>
				</div>
			</div>
		</div>
		...
		<div style="float: left;width: 100%; border-top: 1px solid #efefef;border-bottom: 1px solid #efefef;    text-align: right;">
			<p style="margin-bottom: 8px; font-size: 13px; float: left;width: 100%; direction: rtl;">ّ هل عجبك المنتج الجديد الذي قمت بشرائه؟ شارك صورة على إنستجرام ووسمها لنا
 #Souqpack_Packaging</p>
			<p style="margin-bottom: 8px; margin-top: 0; font-size: 13px; float: left;width: 100%;">ً دائما يسعدنا تسوقك على سوق باك وفي انتظارك المرة القادمة
</p>
		</div>
