...
<div class="wrap" style="width: 793px;">
	<div class="header">
		<img src="<?php echo base_url().'resources/emails/corde_final_ar.jpg';?>" alt="order received">
	</div>
	<div class="inner_content" style="float: left;width: 100%;padding: 23px 66px;box-sizing: border-box;">
		...
		<div style="float: left; width: 100%; margin-bottom: 20px;text-align: right;direction: rtl;">
			...
			مبروك تم الإنتهاء من تصنيع طلبكم الخاص[ORDER_NUMBER] كما توقعت بأدق معايير الجودة
			<br>
			نرجوا سداد الدفعة النهائية حتى يتمكن قسم اللوجستيك بتسليم طلبكم حسب الوقت المحدد<br>
			فريق سوق باك يسعد دائما بخدمتكم
		</div>
		<div style="width: 100%; float: left;margin-bottom: 15px;">
			<a href="https://souqpack.com/#/view-custom-order/[ORDER_NUMBER_LINK]" target="_blank">
				<button type="button" style="background: #f1c30e;border: 1px solid #f1c30e;color: #fff;padding: 7px 20px;border-radius: 2px; cursor: pointer;">انقر للدفع</button>
			</a>
		</div>
		...
		<div style="float: right;width: 100%; margin-top: 10px; margin-bottom: 30px; text-align: right;">
				<span style="color: #7ecc20; font-weight: bold; float: right;">في انتظار الدفعة النهائية</span>
		</div>
		<div style="float: left;width: 100%;">
			<div style="float: right;width: 42%; margin-left: 1%; background: #f6f6f6; padding: 15px 20px;height: 100px; text-align: right;" >
				...
				<div style="float: left;width: 100%;margin-bottom: 3px;">
					...
					<span style="float: right;font-size: 11px;    direction: rtl;">[AMOUNT_TO_PAY]</span>
				</div>
				<div style="float: left;width: 100%;">
			...
			<div style="float: right;width: 42%; margin-left: 1%; background: #f6f6f6; padding: 15px 20px;height: 100px;">
				<b style="font-weight: bold; float: right;width: 100%; margin-bottom: 10px;     text-align: right;">عنوان الإستلام</b>
