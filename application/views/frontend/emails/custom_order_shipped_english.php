...
<div class="wrap" style="width: 793px;">
	<div class="header">
		<img src="<?php echo base_url().'resources/emails/corde_shipped_en.jpg';?>">
	</div>
	<div class="inner_content" style="float: left;width: 100%;padding: 23px 66px;box-sizing: border-box;">
		...
		<div style="float: left; width: 100%; margin-bottom: 20px;">
			Hello, the order you had placed [ORDER_NUMBER] will be finally delivered to you, we
will be glad to work with you next time. We strive to provide the best quality service and
we look forward to hearing from you about your experience with us.
		...
		<div style="width: 100%;float: left;">
			...
			<div style="float: left;width: 8%; background: #7ecc20; padding: 5px;margin-right: 10px;"></div>
			<div style="float: left;width: 19%; background: #7ecc20; padding: 5px;"></div>
		</div>


		<div style="float: left;width: 100%; margin-top: 15px; margin-bottom: 20px;">
				<span style="color: #7ecc20; font-weight: bold; float: left;">ORDER Shipped!</span>
		</div>
