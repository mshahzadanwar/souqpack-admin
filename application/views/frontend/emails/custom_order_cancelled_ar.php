...
<div class="wrap" style="width: 793px;">
	<div class="header">
		<img src="<?php echo base_url().'resources/emails/corde_cancelled_ar.jpg';?>" alt="order received">
	</div>
	<div class="inner_content" style="float: left;width: 100%;padding: 23px 66px;box-sizing: border-box;">
		...
		<div style="float: left; width: 100%; margin-bottom: 20px;text-align: right;direction: rtl;">
			 نأسف جدا تم إلغاء طلبكم  [ORDER_NUMBER] , لا يلبي الجودة المطلوبة التى نريدها
			 <br>
			 يجب إعادة أموالك إلى البنك الذى تتعامل معه في غضون 7 إلى 14 ً يوم عمل. لانرغب في إرجاع منتجك أبدا
نأسف لأي إزعاج
		</div>
		...
		<div style="float: right;width: 100%; margin-top: 10px; margin-bottom: 30px; text-align: right;">
				<span style="color: red; font-weight: bold; float: right;">طلبك في الطريق إلينا
</span>
		</div>
		<div style="float: left;width: 100%;">
			<div style="float: right;width: 92%; margin-left: 1%; background: #f6f6f6; padding: 15px 20px;height: 100px; text-align: right;" >
