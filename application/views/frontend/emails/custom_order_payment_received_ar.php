...
<div class="wrap" style="width: 793px;">
	<div class="header">
		<img src="<?php echo base_url().'resources/emails/corde_payment_ar.jpg';?>" alt="order received">
	</div>
	<div class="inner_content" style="float: left;width: 100%;padding: 23px 66px;box-sizing: border-box;">
		...
		<div style="float: left; width: 100%; margin-bottom: 20px;text-align: right;direction: rtl;">
			تم استلام دفعتك لطلب [ORDER_NUMBER] 
			 الأن طلبكم قيد الإنتاج والجودة نحرص دائما
ً علي تقديم أفضل المنتجات صديقة للبيئة ، ايضا سرعة وإنجاز طلبكم محل اهتمام دائم نشكركم
لإختيار سوق باك شريك دائم للعمل معكم
		</div>
		...
		<div style="float: right;width: 100%; margin-top: 10px; margin-bottom: 30px; text-align: right;">
				<span style="color: #7ecc20; font-weight: bold; float: right;">تم استلام دفعتك بنجاح</span>
		</div>
