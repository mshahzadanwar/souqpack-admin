...
<div class="wrap" style="width: 793px;">
	<div class="header">
		<img src="<?php echo base_url().'resources/emails/corde_payment_en.jpg';?>">
	</div>
	<div class="inner_content" style="float: left;width: 100%;padding: 23px 66px;box-sizing: border-box;">
		...
		<div style="float: left; width: 100%; margin-bottom: 20px;">
			Your payment was received on behalf of your order [ORDER_NUMBER]. Now your
request is under production and quality. We only try to deliver the most friendly goods
for the environment. The speed and completion of your request is also of constant
concern. Thank you for choosing Souqpack as your permanent companion
		</div>
		...
		<div style="width: 100%;float: left;">
			...
			<div style="float: left;width: 8%; background: #7ecc20; padding: 5px;margin-right: 10px;"></div>
			<div style="float: left;width: 19%; background: #7ecc20; padding: 5px;margin-right: 10px;"></div>
		...
		<div style="float: left;width: 100%; margin-top: 15px; margin-bottom: 20px;">
				<span style="color: #7ecc20; font-weight: bold; float: left;">Payment Received</span>
		</div>
		<div style="float: left;width: 100%;">
			<div style="float: left;width: 42%; margin-right: 1%; background: #f6f6f6; padding: 15px 20px;height: 100px;">
				...
				<div style="float: left;width: 100%;margin-bottom: 10px;">
					<span style="float: left; margin-right: 20px; font-size: 11px;width: 40%;">Amount Paid: </span>
