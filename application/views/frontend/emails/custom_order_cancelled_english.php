...
<div class="wrap" style="width: 793px;">
	<div class="header">
		<img src="<?php echo base_url().'resources/emails/corde_cancelled_en.jpg';?>">
	</div>
	<div class="inner_content" style="float: left;width: 100%;padding: 23px 66px;box-sizing: border-box;">
		...
		<div style="float: left; width: 100%; margin-bottom: 20px;">
			We are extremely sorry that your order [ORDER_NUMBER] was canceled, it does not comply
with the standard needed, your money must be returned to your bank in 7 to 14 working days.
Sorry for the inconvenience.
		</div>
		
		<div style="width: 100%;float: left;">
			<div style="float: left;width: 100%; background: red; padding: 5px;margin-right: 10px;"></div>
			
		</div>


		<div style="float: left;width: 100%; margin-top: 15px; margin-bottom: 20px;">
				<span style="color: red; font-weight: bold; float: left;">ORDER CANCELED</span>
		</div>
		<div style="float: left;width: 100%;">
			<div style="float: left;width: 96%;  background: #f6f6f6; padding: 15px 20px;height: 100px;">
				...
				<div style="float: left;width: 100%;margin-bottom: 10px;">
					<span style="float: left; margin-right: 20px; font-size: 11px;width: 40%;">Amount: </span>
