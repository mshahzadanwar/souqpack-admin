...
<div class="wrap" style="width: 793px;">
	<div class="header">
		<img src="<?php echo base_url().'resources/emails/corde_shipped_ar.jpg';?>" alt="order received">
	</div>
	<div class="inner_content" style="float: left;width: 100%;padding: 23px 66px;box-sizing: border-box;">
		...
		<div style="float: left; width: 100%; margin-bottom: 20px;text-align: right;direction: rtl;">
			...
			مرحبا ً ، أخيرا طلبك  [ORDER_NUMBER] في الطريق إليك ، يسعدنا العمل معك المرات القادمة			<br>
			لا تنسي تقييم المنتج ومشاركة تجربتك في سوق باك ، يتمني لكم فريق سوق باك التوفيق دائما		</div>
		...
		<div style="float: right;width: 100%; margin-top: 10px; margin-bottom: 30px; text-align: right;">
				<span style="color: #7ecc20; font-weight: bold; float: right;">طلبك في الطريق الأن</span>
		</div>
