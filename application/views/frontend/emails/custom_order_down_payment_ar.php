...
<div class="wrap" style="width: 793px;">
	<div class="header">
		<img src="<?php echo base_url().'resources/emails/corde_partial_ar.jpg';?>" alt="order received">
	</div>
	<div class="inner_content" style="float: left;width: 100%;padding: 23px 66px;box-sizing: border-box;">
		...
		<div style="float: left; width: 100%; margin-bottom: 20px;text-align: right;direction: rtl;">
			تهانينا تم استلام تعميدكم علي تصميمك الخاص الأن يقوم قسم الإنتاج مباشرة بتجهيز طلبكم<br>
			[ORDER_NUMBER] نرجوا تأكيد الدفع لإنطلاق مرحلة الإنتاج بتصنيع طلبكم!!
		</div>
		...
		<div style="float: right;width: 100%; margin-top: 10px; margin-bottom: 30px; text-align: right;">
				<span style="color: #7ecc20; font-weight: bold; float: right;">في انتظار الدفعة المقدمة</span>
		</div>
