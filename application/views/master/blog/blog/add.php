...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
             <form class="form" method="post" name="addCat" id="addCat" action="<?php echo base_url('save-category')?>" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                    <div class="card-body"> 
                                        ...
                                        <div class="row mt-5" id="en-section"> 
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type='text' id="blog_title2" name="blog_title2" class="form-control form-control-line" required> 
                                                </div>
                                            </div>  
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type='text' id="blog_slug" name="blog_slug" class="form-control" required>
                                                </div>
                                            </div>  
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" id="input-file-disable-remove" class="dropify" data-show-remove="false" name="blog_image2" data-default-file="" />
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="blog_short_description2" name="blog_short_description2" class="form-control"></textarea>
                                                </div>
                                            </div>  
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="blog_content2"   class="form-control"></textarea>
                                                </div>
                                            </div>                                      
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type='text' id="blog_meta_title2" name="blog_meta_title2" class="form-control">
                                                </div>
                                            </div> 
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="blog_meta_keywords2" name="blog_meta_keywords2" class="form-control"></textarea> 
                                                </div>
                                            </div> 
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="blog_meta_description2" name="blog_meta_description2" class="form-control"></textarea>
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="row mt-5 d-none" id="ar-section"> 
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type='text' id="blog_title1" name="blog_title1" class="form-control form-control-line" required> 
                                                </div>
                                            </div>    
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" id="input-file-disable-remove" class="dropify" data-show-remove="false" name="blog_image1" data-default-file="" />
                                                    <div class="text-danger"></div> 
                                                </div>
                                            </div> 
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="blog_short_description1" name="blog_short_description1" class="form-control"></textarea>
                                                </div>
                                            </div>  
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="blog_content1"   class="form-control" class="textarea_editor mymce"></textarea>
                                                </div>
                                            </div>                                      
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type='text' id="blog_meta_title1" name="blog_meta_title1" class="form-control" >
                                                </div>
                                            </div> 
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="blog_meta_keywords1" name="blog_meta_keywords1" class="form-control"></textarea> 
                                                </div>
                                            </div> 
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="blog_meta_description1" name="blog_meta_description1" class="form-control"></textarea>
                                                </div>
                                            </div>                                       
                                        </div> 
                                        <br>
                                        <div class="row" style="float: right">
                                            ...
                                            <button type="button" class="btn btn-outline-danger waves-effect waves-light" onclick="window.location.href='<?php echo base_url('blog-master');?>'" data-dismiss="modal">Close</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
