        ...
        <div class="col-12">
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Add New vendor
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group <?=(form_error('phone') !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <input type="tel" class="form-control form-control-line" placeholder="Phone Address" required data-validation-required-message="This field is required" name="phone" value="<?php if(set_value('phone') != ''){ echo set_value('phone');}else echo $prev->phone; ?>">
            ...
            <div class="card-body">
                <div class="text-xs-right">
                    ...
                    <a href="<?=$url;?>admin/vendors" class="btn btn-inverse">Cancel</a>
                </div>
            </div>
            <?=form_close();?>
        </div>
