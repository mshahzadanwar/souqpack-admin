            ...
            <div class="card">
                ...
                <div class="card-body lang_bodieslisting" id="lang-<?php echo $language->id; ?>listing"
                    ...
                    <div class="form-group <?=(form_error('category') !='')?'error':'';?>">
                        ...
                        <select onchange="getProducts(this,<?php echo $this->input->post('product')?$this->input->post('product'):0; ?>)" class="custom-select form-control required" id="category" name="category" required>
                               ...
                               <?php foreach($categories->result() as $category){?>
                                   <option <?php if($category->id == $this->input->post('category') || $data->category==$category->id){ echo 'selected="selected"';}?>  value="<?php echo $category->id;?>"><?php echo $category->title;?></option>
                                <?php } ?>
                    ...
                    <div class="easy add_products_view_inside_me">
                        <?php if($this->input->post('category')!="" || !empty($data))
                        {
                            $cat = $this->input->post('category')?$this->input->post('category'):$data->category;
                            $pos = $this->input->post('product')?$this->input->post('product'):$data->product;
                    ...
                    <div class="form-group <?=(form_error('discount_type') !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <select class="form-control form-control-line" name="discount_type" required>
                                <option <?php if($this->input->post("discount_type")=="0"  || $data->discount_type=="0") echo "selected"; ?> value="0">None</option>
                                <option <?php if($this->input->post("discount_type")=="1"  || $data->discount_type=="1") echo "selected"; ?> value="1">Flat</option>
                                <option <?php if($this->input->post("discount_type")=="2"  || $data->discount_type=="2") echo "selected"; ?> value="2">Percent</option>
                            </select>
                    ...
                    <div class="form-group <?=(form_error('discount') !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="number" step="0.1" name="discount" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="0" value="<?php if(set_value('discount') != ''){ echo set_value('discount');}else echo $data->discount;?>">
                    ...
                    <div class="form-group <?=(form_error('applies_on_date') !='')?'error':'';?>">
                        ...
                        <div class="controls">
                           <input <?php if($this->input->post('applies_on_date')==1 || $data->applies_on_date==1) echo "checked"; ?> type="checkbox" value="1" onclick="date_applies_checked(this)" name="applies_on_date">
                    ...
                    <div class="col-12 nopad date_applies" style="display: <?php if($this->input->post('applies_on_date')!=1) echo "none"; ?>;">
                        <div class="col-md-3 nopad">
                            <div class="form-group <?=(form_error('start_date') !='')?'error':'';?>">
                                <h5>Start Date: </h5>
                                <div class="controls">
                                    <input type="text" class="form-control publish required" name="start_date" value="<?php if(set_value('start_date') != ''){ echo set_value('start_date');}else echo date("Y-m-d",strtotime($data->start_date)); ?>">
                        ...
                        <div class="col-md-3 nopad">
                            <div class="form-group <?=(form_error('end_date') !='')?'error':'';?>">
                                <h5>End Date: </h5>
                                <div class="controls">
                                    <input type="text" class="form-control publish required" name="end_date" value="<?php if(set_value('end_date') != ''){ echo set_value('end_date');}else echo date("Y-m-d",strtotime($data->end_date));?>">
                    ...
                    <div class="form-group <?=(form_error('min_qty') !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <select class="form-control form-control-line" name="min_qty" required>
                                ...
                                <?php for($i=1;$i<=20;$i++){ ?>
                                    <option <?php if($this->input->post('min_qty')==$i || $data->min_qty==$i) ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                <?php } ?>
                            </select>
                            ...
                            <div class="col-lg-6 col-md-6 nopad">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <input type="file" id="input-file-disable-remove" class="dropify" data-show-remove="false" name="<?php echo $input; ?>" data-default-file="<?php echo $url."resources/";?>uploads/offers/<?php echo $data->image;?>" />
                                        <div class="text-danger"><?php echo form_error($input);?></div>
                                    </div>
                                </div>
                            </div>
