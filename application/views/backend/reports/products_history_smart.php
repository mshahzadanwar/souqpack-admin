                    ...
                    <div class="col-12">
                        <div class="right " style="float: right;">
                            ...
                            $products = $this->db->get();
                                    ...
                                    <?php if($_GET["start_date"]!="" || $_GET["to_date"]!="" || $_GET["product_id"]!=""){ ?>
                    ...
                    <div class="table-responsive m-t-40">
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            foreach($products->result() as $product){
                                ...
                                if($_GET["product_id"]!="")
                                {
                                    if($product->id!=$_GET["product_id"]) continue;
                                }
                                ...
                                foreach($order_products as $order_product)
                                {
                                    ...
                                    if($_GET["start_date"]!="")
                                    {
                                        if($order_this->created_at<$_GET["start_date"]) continue;
                                    }
                                    if($_GET["to_date"]!="")
                                    {
                                        if($order_this->created_at>$_GET["to_date"]) continue;
                                    }
                                    ...
                                    if($prod_order_this_c_total==0) continue;
