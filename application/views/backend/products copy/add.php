                ...
                <?php foreach($languages as $language){ ?>
                 <div class="card-body lang_bodieslisting" id="lang-<?php echo $language->id; ?>listing"
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="text" name="<?php echo $input; ?>" class="form-control form-control-line"  placeholder="Title" value="<?php if(set_value($input) != ''){ echo set_value($input);}else echo $prev->title;?>">
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="number" step="1" name="<?php echo $input; ?>" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="0" value="<?php if(set_value($input) != ''){ echo set_value($input);}else echo $prev->min_order_qty;?>">
                            <div class="text-danger"><?php echo form_error($input);?></div>
                        </div>
                    </div>
                    <?php } ?>
