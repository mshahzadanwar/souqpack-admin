...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Blogs Management</h3>
            <ol class="breadcrumb">
        ...
        <div class="col-12">
            ...
            <div class="card ">
                ...
                <?php foreach($languages as $language){
                    $data = $this->page->get_blog_by_lang($language->id,$the_id);
                 ?>
                            ...
                            <div class="col-lg-6 col-md-6 nopad">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <input type="file" id="input-file-disable-remove" class="dropify" data-show-remove="false" name="<?php echo $input; ?>" data-default-file="<?php echo $root;?>resources/uploads/blogs/<?php echo $data->image;?>" />
                                        <div class="text-danger"><?php echo form_error($input);?></div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card-body">
                <div class="text-xs-right">
                    ...
                    <a href="<?=$url;?>blogs" class="btn btn-inverse">Cancel</a>
                </div>
            </div>
            <?=form_close();?>
        </div>
