    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo $url."admin/blogs";?>">Blogs</a></li>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Information
                        <a 
                        href="<?php echo base_url()."admin/add-blog?replicate=1" ?>">
            ...
            <div class="card-body">
                <div class="text-xs-right">
                    ...
                    <a href="<?=$url;?>admin/blogs" class="btn btn-inverse">Cancel</a>
                </div>
            </div>
            <?=form_close();?>
        </div>
