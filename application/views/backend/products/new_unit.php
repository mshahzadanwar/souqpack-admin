...
<div class="card" style="float: left;width: 98%; margin-left: 1px;">
...
<div style="padding: 20px; background: #d8d8d8; border:1px dotted #d8d8d8; float: left; width: 100%;">
    ...
    <div class="easy form-group " style="padding-bottom: 0; margin-bottom: 0;">
        <div class="row">
                        ...
                        <div class="col-6" style="float: left;display: none;">
                                ...
                                <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                                    ...
                                    <select class="custom-select form-control required" name="<?php echo $input; ?>">
                                           ...
                                           <?php 
                                           $q_units = $this->db->where("status",1)->where("lparent",0)->where("is_deleted",0)->where("hidden",1)->get("regions")->result_object();
                                           foreach($q_units as $q_unit){
                                            ...
                                            ?>
                                                ...
                                                <?php if($q_unit->id == $this->input->post($input) || $q_unit->id==1){ echo 'selected="selected"';}?>  value="<?php echo $q_unit->id;?>"><?php echo $q_unit->title;?></option>
