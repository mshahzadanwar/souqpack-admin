    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add New Company Detail</li>
            </ol>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group <?=(form_error('company_name') !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="text" name="company_name" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="Company Name" value="<?php if(set_value('company_name') != ''){ echo set_value('company_name');}else echo $prev->company_name;?>" >
                    ...
                    <div class="form-group <?=(form_error('email') !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="text" name="email" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="Email" value="<?php if(set_value('email') != ''){ echo set_value('email');}else echo $prev->email;?>" >
                    ...
                    <div class="form-group <?=(form_error('phone') !='')?'error':'';?>">
                        <h5>Phone </h5>
                        <div class="controls">
                            <input type="text" name="phone" class="form-control form-control-line" placeholder="Phone" value="<?php if(set_value('phone') != ''){ echo set_value('phone');}else echo $prev->phone;?>" >
                    ...
                    <div class="form-group <?=(form_error('mobile') !='')?'error':'';?>">
                        <h5>Mobile </h5>
                        <div class="controls">
                            <input type="text" name="mobile" class="form-control form-control-line" placeholder="Mobile" value="<?php if(set_value('mobile') != ''){ echo set_value('mobile');}else echo $prev->mobile;?>" >
                    ...
                    <div class="form-group <?=(form_error('address') !='')?'error':'';?>">
                        <h5>Address </h5>
                        <div class="controls">
                            <textarea class="mymce form-control form-control-line" id="mymce" name="address" ><?php if(set_value('address') != ''){ echo set_value('address');}else echo $prev->address;?></textarea>
