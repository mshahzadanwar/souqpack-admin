            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Information
                        <a 
                        href="<?php echo base_url()."admin/add-store?replicate=1" ?>">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group <?=(form_error('email') !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="email" name="email" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="email" value="<?php if(set_value('email') != ''){ echo set_value('email');}else echo $prev->email;?>" >
                    ...
                    <div class="form-group <?=(form_error('phone') !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="tel" name="phone" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="Phone" value="<?php if(set_value('phone') != ''){ echo set_value('phone');}else echo $prev->phone;?>" >
                    ...
                    <div class="form-group <?=(form_error('address') !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="text" name="address" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="Address" value="<?php if(set_value('address') != ''){ echo set_value('address');}else echo $prev->address;?>" >
                            ...
                            <div class="col-lg-6 col-md-6 nopad">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <input type="file" id="input-file-disable-remove" class="dropify" data-show-remove="false" name="banner" data-default-file="" />
