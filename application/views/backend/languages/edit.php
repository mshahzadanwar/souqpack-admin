                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group <?=(form_error('title') !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <input type="text" name="title" class="form-control" required data-validation-required-message="This field is required" placeholder="Title" value="<?php if(set_value('title') != ''){ echo set_value('title');}else echo $data->title;?>">
                            ...
                            <div class="form-group <?=(form_error('direction') !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <select class="custom-select form-control" id="direction" name="direction" required data-validation-required-message="This field is required">
                                        ...
                                        <option <?php if($this->input->post('direction')== 'LTR' || $data->direction=="LTR"){ echo 'selected="selected"';}?> value="LTR">LTR</option>
                                        <option <?php if($this->input->post('direction')== 'RTL' || $data->direction=="RTL"){ echo 'selected="selected"';}?> value="RTL">RTL</option>
                            ...
                            <div class="col-lg-6 col-md-6 nopad">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <input type="file" id="input-file-disable-remove" class="dropify" data-show-remove="false" name="image" data-default-file="<?php echo $url."resources/";?>uploads/languages/<?php echo $data->image;?>" />
