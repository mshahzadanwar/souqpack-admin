    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add New Shipment Method</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Add New Shipment Methods
                               ...
                               <?php foreach($categories->result() as $pcategory){
                                ...
                                <optgroup label="<?php echo $pcategory->title; ?>">
                                    <?php
                                     ...
                                     ?>
                                     <option <?php if($category->id == $this->input->post($input) || $prev->category==$category->id){ echo 'selected="selected"';}?>  value="<?php echo $category->id;?>"><?php echo $category->title;?></option>
