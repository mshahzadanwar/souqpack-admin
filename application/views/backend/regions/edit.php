        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <?php foreach($languages as $language){
                    $data = $this->region->get_region_by_lang($language->id,$the_id);
                 ?>
                <div class="card-body lang_bodieslisting" id="lang-<?php echo $language->id; ?>listing"
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="number" step="0.1" name="<?php echo $input; ?>" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="VAT %" value="<?php if(set_value($input) != ''){ echo set_value($input);}else echo $data->vat;?>" >
                            <div class="text-danger"><?php echo form_error($input);?></div>
                        </div>
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="text" name="<?php echo $input; ?>" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="Currency Symbol" value="<?php if(set_value($input) != ''){ echo set_value($input);}else echo $data->currency;?>" >
                            <div class="text-danger"><?php echo form_error($input);?></div>
                        </div>
