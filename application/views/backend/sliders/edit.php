        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <?php foreach($languages as $language){
                    $data = $this->slider->get_slider_by_lang($language->id,$the_id);
                 ?>
                               ...
                               foreach($categories->result() as $pcategory){
                                ...
                                <optgroup label="<?php echo $one->title . ' / ' .$two->title ;?>">
                                    <?php
                                     ...
                                     ?>
                                     <option <?php if($value_id == $this->input->post($input) || $data->cat_slug==$one->slug){ echo 'selected="selected"';}?>  value="<?php echo $one->slug;?>"><?php echo $one->title . ' / ' .$two->title ;?></option>
                            ...
                            <div class="col-lg-6 col-md-6 nopad">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <input type="file" id="input-file-disable-remove" class="dropify" data-show-remove="false" name="<?php echo $input; ?>" data-default-file="<?php echo $url."resources/";?>uploads/sliders/<?php echo $data->image;?>" />
                                        <div class="text-danger"><?php echo form_error($input);?></div>
                                    </div>
                                </div>
                            </div>
