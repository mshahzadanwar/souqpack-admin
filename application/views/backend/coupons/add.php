                ...
                <div class="card-header">
                 ...
                 <div class="card-body lang_bodieslisting" id="lang-<?php echo $language->id; ?>listing"
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="text" name="<?php echo $input; ?>" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="Code" value="<?php if(set_value($input) != ''){ echo set_value($input);}else echo $prev->code;?>" >
                            <div class="text-danger"><?php echo form_error($input);?></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="number" step="0.1" name="<?php echo $input; ?>" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="0" value="<?php if(set_value($input) != ''){ echo set_value($input);}else echo $prev->discount;?>">
                            <div class="text-danger"><?php echo form_error($input);?></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="date"  name="<?php echo $input; ?>" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="Valid From" value="<?php if(set_value($input) != ''){ echo set_value($input);}else echo $prev->from_date;?>">
                            <div class="text-danger"><?php echo form_error($input);?></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group <?=(form_error($input) !='')?'error':'';?>">
                        ...
                        <div class="controls">
                            <input type="date"  name="<?php echo $input; ?>" class="form-control form-control-line" required data-validation-required-message="This field is required" placeholder="Valid Till" value="<?php if(set_value($input) != ''){ echo set_value($input);}else echo $prev->to_date;?>">
                            <div class="text-danger"><?php echo form_error($input);?></div>
                        </div>
                    </div>
                    <?php } ?>
